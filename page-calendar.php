...
<div id="content">
	...
	<div class="primary">
		...
		<a href="<?php bloginfo("url"); ?>/race/roster"><div class="content_header">Roster</div></a>
		<a href="<?php bloginfo("url"); ?>/race/calendar"><div class="content_header" id="active">Calendar</div></a>
